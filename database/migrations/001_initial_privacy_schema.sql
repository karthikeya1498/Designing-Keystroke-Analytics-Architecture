-- AegisKey migration 001: privacy-first foundation.
-- Apply with a migration runner that records this filename in its schema history table.
-- The statements are idempotent for safe recovery from interrupted deployments.
